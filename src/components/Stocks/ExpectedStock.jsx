...
export default function ExpectedStock({ requests = [] }) {
        ...
        <div className="w-full md:w-[65%]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white shadow-sm rounded-lg p-4 border-l-4 border-blue-500">
              <h3 className="text-sm font-medium text-gray-600">Installer</h3>
              <p className="text-2xl font-bold text-gray-900">
                120 <span className="text-sm font-normal text-black">Qty</span>
              </p>
            </div>
            <div className="bg-white shadow-sm rounded-lg p-4 border-l-4 border-orange-500">
              ...
              <p className="text-2xl font-bold text-gray-900">
                89 <span className="text-sm font-normal text-black">Qty</span>
              </p>
            </div>
            <div className="bg-white shadow-sm rounded-lg p-4 border-l-4 border-red-500">
              ...
              <p className="text-2xl font-bold text-gray-900">
                400 <span className="text-sm font-normal text-black">Qty</span>
              </p>
            </div>
          </div>
        </div>
